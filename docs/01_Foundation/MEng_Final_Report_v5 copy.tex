...
\begin{itemize}
    ...
    \item \textbf{Full Technical Archive}: \url{docs/01_Foundation/Supplementary_Technical_Evidence.md}
    \item \textbf{System \& State Verification}: \texttt{docs/01\_Foundation/Discovery\_And\_Drafts/} (\textit{System\_Overview.md}, \textit{Project\_State\_Verification.md}, \textit{Final\_Project\_Markdown\_Report.md})
    \item \textbf{Audit Infrastructure}: \texttt{docs/01\_Foundation/Discovery\_And\_Drafts/} (\textit{Issues\_Log.md}, \textit{Master\_File\_Manifest.md})
    \item \textbf{Hyper-parameter Optimization}: \texttt{docs/02\_Technical\_Specs/Optimization\_Log.md}
    \item \textbf{Visual Assets \& Plots}: \texttt{docs/assets/} (Raw empirical plots and charts)
...
\begin{itemize}[leftmargin=*, nosep]
 \item \textbf{RQ1}: Can $(\epsilon, \delta)$-DP maintain $> 85\%$ diagnostic accuracy for high-dimensional indicators compared to the centralised baseline (e.g., CDC-Diabetes)?
...
Test 2 & Thyroid & Multi-class Federated Convergence (89.7\% Acc) & \texttt{thyroid\_results-negligible-mi} \\
...
MedShare-FL successfully demonstrates that decentralized clinical research is scientifically viable under zero-trust conditions. By reaching \textbf{86.7\% accuracy} on massive datasets while neutralizing adversaries via \textbf{Robust-MAD}, the project proves that institutional "Trust Deficits" can be overcome through technical orchestration.
...
Due to the 11-page limit, the extensive \textbf{Appendices (A-R)}, including mathematical proofs and hyper-parameter logs, are available at: \\
...
\bibitem{chawla2002} N. Chawla et al., "SMOTE," \textit{JAIR}, 2002.
\bibitem{geyer2017} R. C. Geyer et al., "DP FL," \textit{arXiv}, 2017.
\bibitem{douceur2002} J. R. Douceur, "The Sybil Attack," \textit{IPTPS}, 2002.
\bibitem{kairouz2021} P. Kairouz et al., "Advances in FL," \textit{Found. Trends}, 2021.
\bibitem{cdc2015} CDC, "BRFSS Survey Data," 2015.
\bibitem{knaus1995} W. A. Knaus et al., "SUPPORT Prognostic Model," \textit{Ann. Int. Med.}, 1995.
\bibitem{uci-thyroid} UCI Repository, "Thyroid Disease Dataset," 1987.
\bibitem{dworkroth2014} C. Dwork and A. Roth, "Foundations of DP," 2014.
\bibitem{hardt2016} M. Hardt et al., "Train Faster, Generalize Better," \textit{ICML}, 2016.
\end{thebibliography}
